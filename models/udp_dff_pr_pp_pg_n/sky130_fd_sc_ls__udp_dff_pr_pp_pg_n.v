...
`ifndef SKY130_FD_SC_LS__UDP_DFF_PR_PP_PG_N_V
`define SKY130_FD_SC_LS__UDP_DFF_PR_PP_PG_N_V
...
`ifdef NO_PRIMITIVES
`include "./sky130_fd_sc_ls__udp_dff_pr_pp_pg_n.blackbox.v"
`else
primitive sky130_fd_sc_ls__udp_dff$PR_pp$PG$N (
    Q       ,
    D       ,
    CLK     ,
    RESET   ,
...
`endif  // SKY130_FD_SC_LS__UDP_DFF_PR_PP_PG_N_V
