...
`ifndef SKY130_FD_SC_LS__UDP_DFF_PS_V
`define SKY130_FD_SC_LS__UDP_DFF_PS_V
...
`ifdef NO_PRIMITIVES
`include "./sky130_fd_sc_ls__udp_dff_ps.blackbox.v"
`else
primitive sky130_fd_sc_ls__udp_dff$PS (
    Q  ,
    D  ,
    CLK,
    SET
...
`endif  // SKY130_FD_SC_LS__UDP_DFF_PS_V
