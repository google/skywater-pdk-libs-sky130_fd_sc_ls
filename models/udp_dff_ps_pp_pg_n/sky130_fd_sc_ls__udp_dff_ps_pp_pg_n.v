...
`ifndef SKY130_FD_SC_LS__UDP_DFF_PS_PP_PG_N_V
`define SKY130_FD_SC_LS__UDP_DFF_PS_PP_PG_N_V
...
`ifdef NO_PRIMITIVES
`include "./sky130_fd_sc_ls__udp_dff_ps_pp_pg_n.blackbox.v"
`else
primitive sky130_fd_sc_ls__udp_dff$PS_pp$PG$N (
    Q       ,
    D       ,
    CLK     ,
    SET     ,
...
`endif  // SKY130_FD_SC_LS__UDP_DFF_PS_PP_PG_N_V
