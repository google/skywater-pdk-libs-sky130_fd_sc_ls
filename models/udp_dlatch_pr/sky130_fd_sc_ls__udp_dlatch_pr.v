...
`ifndef SKY130_FD_SC_LS__UDP_DLATCH_PR_V
`define SKY130_FD_SC_LS__UDP_DLATCH_PR_V
...
`ifdef NO_PRIMITIVES
`include "./sky130_fd_sc_ls__udp_dlatch_pr.blackbox.v"
`else
primitive sky130_fd_sc_ls__udp_dlatch$PR (
    Q    ,
    D    ,
    GATE ,
    RESET
...
`endif  // SKY130_FD_SC_LS__UDP_DLATCH_PR_V
